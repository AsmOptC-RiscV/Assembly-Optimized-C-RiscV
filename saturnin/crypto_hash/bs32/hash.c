 ...
 */
static void saturnin16_block_encrypt(const uint32_t *rc, const uint8_t *key,
                                     uint8_t *buf) {
    DECL_STATE
    uint32_t keybuf[16];
    int i;
...
uint32_t RC_16_7[] = {0x3FBA180C, 0x563AB9AB, 0x125EA5EF, 0x859DA26C,
...
uint32_t RC_16_8[] = {0x3C9B19A7, 0xA9098694, 0x23F878DA, 0xA7B647D3,
...
int crypto_hash_asm(unsigned char *out, const unsigned char *in,
