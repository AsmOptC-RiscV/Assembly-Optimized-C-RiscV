...
#define DECL_STATE uint64_t qw0, qw1, qw2, qw3, qw4, qw5, qw6, qw7;

#define DEC64LE(q, src)                                                        \
    do {                                                                       \
        q = (uint64_t)(src)[0] | ((uint64_t)(src)[1] << 8) |                   \
...
#define DEC512(src)                                                            \
    do {                                                                       \
        ...
        DEC64LE(td6, (src) + 48);                                              \
        DEC64LE(td7, (src) + 56);                                              \
        qw0 = (td0 & 0xFFFF) | ((td2 & 0xFFFF) << 16) |                        \
              ((td4 & 0xFFFF) << 32) | (td6 << 48);                            \
        qw1 = ((td0 & 0xFFFF0000) >> 16) | (td2 & 0xFFFF0000) |                \
              ((td4 & 0xFFFF0000) << 16) | ((td6 & 0xFFFF0000) << 32);         \
        qw2 = ((td0 & 0xFFFF00000000) >> 32) |                                 \
              ((td2 & 0xFFFF00000000) >> 16) | (td4 & 0xFFFF00000000) |        \
              ((td6 & 0xFFFF00000000) << 16);                                  \
        qw3 = (td0 >> 48) | ((td2 & 0xFFFF000000000000) >> 32) |               \
              ((td4 & 0xFFFF000000000000) >> 16) | (td6 & 0xFFFF000000000000); \
        qw4 = (td1 & 0xFFFF) | ((td3 & 0xFFFF) << 16) |                        \
              ((td5 & 0xFFFF) << 32) | (td7 << 48);                            \
        qw5 = ((td1 & 0xFFFF0000) >> 16) | (td3 & 0xFFFF0000) |                \
              ((td5 & 0xFFFF0000) << 16) | ((td7 & 0xFFFF0000) << 32);         \
        qw6 = ((td1 & 0xFFFF00000000) >> 32) |                                 \
              ((td3 & 0xFFFF00000000) >> 16) | (td5 & 0xFFFF00000000) |        \
              ((td7 & 0xFFFF00000000) << 16);                                  \
        qw7 = (td1 >> 48) | ((td3 & 0xFFFF000000000000) >> 32) |               \
              ((td5 & 0xFFFF000000000000) >> 16) | (td7 & 0xFFFF000000000000); \
    } while (0)

#define ENC64LE(dst, q)                                                        \
    do {                                                                       \
        (dst)[0] = (uint8_t)(q);                                               \
        (dst)[1] = (uint8_t)((q) >> 8);                                        \
        (dst)[2] = (uint8_t)((q) >> 16);                                       \
...
#define ENC512(dst)                                                            \
    do {                                                                       \
        uint64_t td0, td1, td2, td3, td4, td5, td6, td7;                       \
        td0 = (qw0 & 0xFFFF) | ((qw1 & 0xFFFF) << 16) |                        \
              ((qw2 & 0xFFFF) << 32) | (qw3 << 48);                            \
        td1 = (qw4 & 0xFFFF) | ((qw5 & 0xFFFF) << 16) |                        \
              ((qw6 & 0xFFFF) << 32) | (qw7 << 48);                            \
        td2 = ((qw0 & 0xFFFF0000) >> 16) | (qw1 & 0xFFFF0000) |                \
              ((qw2 & 0xFFFF0000) << 16) | ((qw3 & 0xFFFF0000) << 32);         \
        td3 = ((qw4 & 0xFFFF0000) >> 16) | (qw5 & 0xFFFF0000) |                \
              ((qw6 & 0xFFFF0000) << 16) | ((qw7 & 0xFFFF0000) << 32);         \
        td4 = ((qw0 & 0xFFFF00000000) >> 32) |                                 \
              ((qw1 & 0xFFFF00000000) >> 16) | (qw2 & 0xFFFF00000000) |        \
              ((qw3 & 0xFFFF00000000) << 16);                                  \
        td5 = ((qw4 & 0xFFFF00000000) >> 32) |                                 \
              ((qw5 & 0xFFFF00000000) >> 16) | (qw6 & 0xFFFF00000000) |        \
              ((qw7 & 0xFFFF00000000) << 16);                                  \
        td6 = (qw0 >> 48) | ((qw1 & 0xFFFF000000000000) >> 32) |               \
              ((qw2 & 0xFFFF000000000000) >> 16) | (qw3 & 0xFFFF000000000000); \
        td7 = (qw4 >> 48) | ((qw5 & 0xFFFF000000000000) >> 32) |               \
              ((qw6 & 0xFFFF000000000000) >> 16) | (qw7 & 0xFFFF000000000000); \
        ENC64LE((dst), td0);                                                   \
        ENC64LE((dst) + 8, td1);                                               \
        ENC64LE((dst) + 16, td2);                                              \
        ENC64LE((dst) + 24, td3);                                              \
...
#define SR_SLICE                                                               \
    do {                                                                       \
        qw0 = (qw0 & 0x0000FFFF0000FFFF) | ((qw0 & 0x3333000033330000) << 2) | \
              ((qw0 >> 2) & 0x3333000033330000);                               \
        qw1 = (qw1 & 0x0000FFFF0000FFFF) | ((qw1 & 0x3333000033330000) << 2) | \
              ((qw1 >> 2) & 0x3333000033330000);                               \
        qw2 = (qw2 & 0x0000FFFF0000FFFF) | ((qw2 & 0x3333000033330000) << 2) | \
              ((qw2 >> 2) & 0x3333000033330000);                               \
        qw3 = (qw3 & 0x0000FFFF0000FFFF) | ((qw3 & 0x3333000033330000) << 2) | \
...
#define SR_SHEET                                                               \
    do {                                                                       \
        qw0 = (qw0 & 0x0000FFFF0000FFFF) | ((qw0 & 0x00FF000000FF0000) << 8) | \
              ((qw0 >> 8) & 0x00FF000000FF0000);                               \
        qw1 = (qw1 & 0x0000FFFF0000FFFF) | ((qw1 & 0x00FF000000FF0000) << 8) | \
              ((qw1 >> 8) & 0x00FF000000FF0000);                               \
        qw2 = (qw2 & 0x0000FFFF0000FFFF) | ((qw2 & 0x00FF000000FF0000) << 8) | \
              ((qw2 >> 8) & 0x00FF000000FF0000);                               \
        qw3 = (qw3 & 0x0000FFFF0000FFFF) | ((qw3 & 0x00FF000000FF0000) << 8) | \
...
uint64_t RC_10_2_bs64[] = {0x4E4526B54E4526B5, 0xA3565FF0A3565FF0,
                           0x0F8F20D80F8F20D8, 0x0B54BEE10B54BEE1,
                           0x7D1A6C9D7D1A6C9D, 0x17A6280A17A6280A,
                           0xAA46C986AA46C986, 0xC1199062C1199062,
                           0x182C5CDE182C5CDE, 0xA00D53FEA00D53FE};

uint64_t RC_10_3_bs64[] = {0x4E1626984E162698, 0xB2535BA1B2535BA1,
                           0x6C8F9D656C8F9D65, 0x5816AD305816AD30,
                           0x691FD4FA691FD4FA, 0x6BF5BCF96BF5BCF9,
                           0xF8EB3525F8EB3525, 0xB21DECFAB21DECFA,
                           0x7B3DA4177B3DA417, 0xF62C94B4F62C94B4};

uint64_t RC_10_combined_1_4_bs64[] = {0x4FAF265B4EB026C2, 0xC548461690595303,
                                      0x45DCAD21AA8FE632, 0xE08BD607FE928A92,
                                      0x0504FDB84115A419, 0x1E1F525793539532,
                                      0x45FBC2165DB1CC4E, 0xEB529B1F541515CA,
                                      0x52194E32BD1F55A8, 0x5498C0185A6E1A0D};

uint64_t RC_10_combined_1_5_bs64[] = {0x4FFC26764EB026C2, 0xD44D424790595303,
                                      0x26DC109CAA8FE632, 0xB3C9C5D6FE928A92,
                                      0x110145DF4115A419, 0x624CC6A493539532,
                                      0x17563EB55DB1CC4E, 0x9856E787541515CA,
                                      0x3108B6FBBD1F55A8, 0x02B907525A6E1A0D};
 ...
 */
static void saturnin_bs64_key_expand_low(uint64_t *keybuf, const uint8_t *key) {
    int i;

    for (i = 0; i < 8; i++) {
        uint32_t w;

        w = (uint32_t)key[(i << 1) + 0] | ((uint32_t)key[(i << 1) + 1] << 8) |
            ((uint32_t)key[(i << 1) + 16] << 16) |
            ((uint32_t)key[(i << 1) + 17] << 24);
        keybuf[i] = (uint64_t)w;
        w = ((w & 0x001F001F) << 11) | ((w >> 5) & 0x07FF07FF);
 ...
 */
static void saturnin_bs64_block_encrypt(int R, const uint64_t *rc,
 ...
 * overlap.
 */
static inline void xor32(uint8_t *d, const uint8_t *a) {
    int i;
 ...
 */
static void do_cascade_aad(uint8_t *r, const uint64_t *keybuf,
...
int crypto_aead_encrypt_bs64(unsigned char *c, unsigned long long *clen,
    ...
    if (len >= 32) {
        ...
        memcpy(tmp, nonce, 32);
        tmp[31] = 0x01;
        saturnin_bs64_block_encrypt(10, RC_10_combined_1_4_bs64, keybuf, tmp);
        xor32(buf, tmp);
        ...
        for (u = 32;;) {
            ...
            saturnin_bs64_block_encrypt(10, RC_10_combined_1_4_bs64, keybuf2,
                                        tmp);
...
int crypto_aead_decrypt_bs64(unsigned char *m, unsigned long long *mlen,
    ...
    for (u = 0; (u + 31) < len; u += 32) {
        ...
        saturnin_bs64_block_encrypt(10, RC_10_combined_1_4_bs64, keybuf2, tmp);
        xor32(tmp + 32, buf + u);
        xor32(buf + u, tmp);
    }
    memcpy(tmp, nonce, 28);
