...
#define DECL_STATE uint32_t q0, q1, q2, q3, q4, q5, q6, q7;

#define DEC256(b, src)                                                         \
    do {                                                                       \
        b##0 = (uint32_t)(src)[0] | ((uint32_t)(src)[1] << 8) |                \
               ((uint32_t)(src)[16] << 16) | ((uint32_t)(src)[17] << 24);      \
        b##1 = (uint32_t)(src)[2] | ((uint32_t)(src)[3] << 8) |                \
               ((uint32_t)(src)[18] << 16) | ((uint32_t)(src)[19] << 24);      \
        b##2 = (uint32_t)(src)[4] | ((uint32_t)(src)[5] << 8) |                \
               ((uint32_t)(src)[20] << 16) | ((uint32_t)(src)[21] << 24);      \
        b##3 = (uint32_t)(src)[6] | ((uint32_t)(src)[7] << 8) |                \
               ((uint32_t)(src)[22] << 16) | ((uint32_t)(src)[23] << 24);      \
        b##4 = (uint32_t)(src)[8] | ((uint32_t)(src)[9] << 8) |                \
               ((uint32_t)(src)[24] << 16) | ((uint32_t)(src)[25] << 24);      \
        b##5 = (uint32_t)(src)[10] | ((uint32_t)(src)[11] << 8) |              \
               ((uint32_t)(src)[26] << 16) | ((uint32_t)(src)[27] << 24);      \
        b##6 = (uint32_t)(src)[12] | ((uint32_t)(src)[13] << 8) |              \
               ((uint32_t)(src)[28] << 16) | ((uint32_t)(src)[29] << 24);      \
        b##7 = (uint32_t)(src)[14] | ((uint32_t)(src)[15] << 8) |              \
               ((uint32_t)(src)[30] << 16) | ((uint32_t)(src)[31] << 24);      \
    } while (0)
...
uint32_t RC_10_1[] = {0x4EB026C2, 0x90595303, 0xAA8FE632, 0xFE928A92,
                      0x4115A419, 0x93539532, 0x5DB1CC4E, 0x541515CA,
                      0xBD1F55A8, 0x5A6E1A0D};

uint32_t RC_10_2[] = {0x4E4526B5, 0xA3565FF0, 0x0F8F20D8, 0x0B54BEE1,
                      0x7D1A6C9D, 0x17A6280A, 0xAA46C986, 0xC1199062,
                      0x182C5CDE, 0xA00D53FE};

uint32_t RC_10_3[] = {0x4E162698, 0xB2535BA1, 0x6C8F9D65, 0x5816AD30,
                      0x691FD4FA, 0x6BF5BCF9, 0xF8EB3525, 0xB21DECFA,
                      0x7B3DA417, 0xF62C94B4};

uint32_t RC_10_4[] = {0x4FAF265B, 0xC5484616, 0x45DCAD21, 0xE08BD607,
                      0x0504FDB8, 0x1E1F5257, 0x45FBC216, 0xEB529B1F,
                      0x52194E32, 0x5498C018};

uint32_t RC_10_5[] = {0x4FFC2676, 0xD44D4247, 0x26DC109C, 0xB3C9C5D6,
 ...
 */
static void saturnin_key_expand(uint32_t *keybuf, const uint8_t *key) {
    int i;
 ...
 */
static void saturnin_block_encrypt(int R, const uint32_t *rc,
 ...
 */
static void do_cascade_init(uint8_t *r, const uint32_t *keybuf,
                            const uint8_t *nonce) {
    size_t u;
 ...
 * Padding is applied.
 */
static void do_cascade(uint8_t *r, const uint32_t *rc1, const uint32_t *rc2,
 ...
 */
static void do_ctr(const uint32_t *keybuf, const uint8_t *nonce, uint8_t *buf,
                   size_t len) {
    uint32_t cc;
    size_t u;
