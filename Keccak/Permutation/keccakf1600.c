...
round0(uint32_t *lanes, uint32_t *rc, uint32_t *a2, uint32_t *a3, uint32_t *a4,
    ...
    *t5 = *a3 ^ *a2;
    ...
    thetarhopi(a4, Aka1, t0, 2, a5, Ame1, t3, 23, a6, Asi1, s2, 31, a2, Abo0,
               s4, 14, a3, Agu0, t4, 10, lanes, t1);
    chipattern0(Aka1, Ame1, Asi1, Abo0, Agu0, a2, a3, a4, a5, a6, lanes, t1);
    thetarhopi(a6, Asa1, t0, 9, a2, Abe0, t2, 0, a3, Agi1, s2, 3, a4, Ako0, s4,
               12, a5, Amu1, t5, 4, lanes, t1);
    chipattern1(Asa1, Abe0, Agi1, Ako0, Amu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a3, Aga0, s0, 18, a4, Ake0, t2, 5, a5, Ami1, s2, 8, a6, Aso0, s4,
               28, a2, Abu1, t5, 14, lanes, t1);
    chipattern2(Aga0, Ake0, Ami1, Aso0, Abu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a5, Ama0, s0, 20, a6, Ase1, t3, 1, a2, Abi1, s2, 31, a3, Ago0,
               s4, 27, a4, Aku0, t4, 19, lanes, t1);
    chipattern3(Ama0, Ase1, Abi1, Ago0, Aku0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopifinal(Aba0, s0, Age0, t2, 22, Aki1, s2, 22, Amo1, s1, 11, Asu0,
                    t4, 7, lanes, a2, a3, a4, a5, a6, t1);
    chiiota(Aba0, Age0, Aki1, Amo1, Asu0, 0, a2, a3, a4, a5, a6, lanes, rc, t1);

    thetarhopi(a4, Aka0, s0, 1, a5, Ame0, t2, 22, a6, Asi0, a7, 30, a2, Abo1,
               s1, 14, a3, Agu1, t5, 10, lanes, t1);
    chipattern0(Aka0, Ame0, Asi0, Abo1, Agu1, a2, a3, a4, a5, a6, lanes, t1);
    thetarhopi(a6, Asa0, s0, 9, a2, Abe1, t3, 1, a3, Agi0, a7, 3, a4, Ako1, s1,
               13, a5, Amu0, t4, 4, lanes, t1);
    chipattern1(Asa0, Abe1, Agi0, Ako1, Amu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a3, Aga1, t0, 18, a4, Ake1, t3, 5, a5, Ami0, a7, 7, a6, Aso1, s1,
               28, a2, Abu0, t4, 13, lanes, t1);
    chipattern2(Aga1, Ake1, Ami0, Aso1, Abu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a5, Ama1, t0, 21, a6, Ase0, t2, 1, a2, Abi0, a7, 31, a3, Ago1,
               s1, 28, a4, Aku1, t5, 20, lanes, t1);
    chipattern3(Ama1, Ase0, Abi0, Ago1, Aku1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopifinal(Aba1, t0, Age1, t3, 22, Aki0, a7, 21, Amo0, s4, 10, Asu1,
                    t5, 7, lanes, a2, a3, a4, a5, a6, t1);
    chiiota(Aba1, Age1, Aki0, Amo0, Asu1, 1, a2, a3, a4, a5, a6, lanes, rc, t1);
}
...
round1(uint32_t *lanes, uint32_t *rc, uint32_t *a2, uint32_t *a3, uint32_t *a4,
    ...
    *t5 = *a3 ^ *a2;
    ...
    // used for masks: r2,r8,r9,r10,r11,r12,lr,mDa0,mDo1,mDi0,mDa1,mDo0
    //           = >  a7,t0,t1, t2, t3, t4,t5,  s0,  s1,  s2,  s3,  s4
    thetarhopi(a4, Asa1, t0, 2, a5, Ake1, t3, 23, a6, Abi1, s2, 31, a2, Amo1,
               s4, 14, a3, Agu0, t4, 10, lanes, t1);
    chipattern0(Asa1, Ake1, Abi1, Amo1, Agu0, a2, a3, a4, a5, a6, lanes, t1);
    thetarhopi(a6, Ama0, t0, 9, a2, Age0, t2, 0, a3, Asi0, s2, 3, a4, Ako1, s4,
               12, a5, Abu0, t5, 4, lanes, t1);
    chipattern1(Ama0, Age0, Asi0, Ako1, Abu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a3, Aka1, s0, 18, a4, Abe1, t2, 5, a5, Ami0, s2, 8, a6, Ago1, s4,
               28, a2, Asu1, t5, 14, lanes, t1);
    chipattern2(Aka1, Abe1, Ami0, Ago1, Asu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a5, Aga0, s0, 20, a6, Ase1, t3, 1, a2, Aki0, s2, 31, a3, Abo0,
               s4, 27, a4, Amu0, t4, 19, lanes, t1);
    chipattern3(Aga0, Ase1, Aki0, Abo0, Amu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopifinal(Aba0, s0, Ame1, t2, 22, Agi1, s2, 22, Aso1, s1, 11, Aku1,
                    t4, 7, lanes, a2, a3, a4, a5, a6, t1);
    chiiota(Aba0, Ame1, Agi1, Aso1, Aku1, 2, a2, a3, a4, a5, a6, lanes, rc, t1);

    thetarhopi(a4, Asa0, s0, 1, a5, Ake0, t2, 22, a6, Abi0, a7, 30, a2, Amo0,
               s1, 14, a3, Agu1, t5, 10, lanes, t1);
    chipattern0(Asa0, Ake0, Abi0, Amo0, Agu1, a2, a3, a4, a5, a6, lanes, t1);
    thetarhopi(a6, Ama1, s0, 9, a2, Age1, t3, 1, a3, Asi1, a7, 3, a4, Ako0, s1,
               13, a5, Abu1, t4, 4, lanes, t1);
    chipattern1(Ama1, Age1, Asi1, Ako0, Abu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a3, Aka0, t0, 18, a4, Abe0, t3, 5, a5, Ami1, a7, 7, a6, Ago0, s1,
               28, a2, Asu0, t4, 13, lanes, t1);
    chipattern2(Aka0, Abe0, Ami1, Ago0, Asu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a5, Aga1, t0, 21, a6, Ase0, t2, 1, a2, Aki1, a7, 31, a3, Abo1,
               s1, 28, a4, Amu1, t5, 20, lanes, t1);
    chipattern3(Aga1, Ase0, Aki1, Abo1, Amu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopifinal(Aba1, t0, Ame0, t3, 22, Agi0, a7, 21, Aso0, s4, 10, Aku0,
                    t5, 7, lanes, a2, a3, a4, a5, a6, t1);
    chiiota(Aba1, Ame0, Agi0, Aso0, Aku0, 3, a2, a3, a4, a5, a6, lanes, rc, t1);
}
...
round2(uint32_t *lanes, uint32_t *rc, reg *p) {
    ...
    // used for masks: r2,r8,r9,r10,r11,r12,lr,mDa0,mDo1,mDi0,mDa1,mDo0
    //           = >  a7,t0,t1, t2, t3, t4, t5,  s0,  s1,  s2,  s3,  s4
    thetarhopi(&p->a4, Ama0, &p->t0, 2, &p->a5, Abe0, &p->t3, 23, &p->a6, Aki0,
               &p->s2, 31, &p->a2, Aso1, &p->s4, 14, &p->a3, Agu0, &p->t4, 10,
               lanes, &p->t1);
    chipattern0(Ama0, Abe0, Aki0, Aso1, Agu0, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1);
    thetarhopi(&p->a6, Aga0, &p->t0, 9, &p->a2, Ame1, &p->t2, 0, &p->a3, Abi0,
               &p->s2, 3, &p->a4, Ako0, &p->s4, 12, &p->a5, Asu0, &p->t5, 4,
               lanes, &p->t1);
    chipattern1(Aga0, Ame1, Abi0, Ako0, Asu0, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1, &p->t6);
    thetarhopi(&p->a3, Asa1, &p->s0, 18, &p->a4, Age1, &p->t2, 5, &p->a5, Ami1,
               &p->s2, 8, &p->a6, Abo1, &p->s4, 28, &p->a2, Aku0, &p->t5, 14,
               lanes, &p->t1);
    chipattern2(Asa1, Age1, Ami1, Abo1, Aku0, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1, &p->t6);
    thetarhopi(&p->a5, Aka1, &p->s0, 20, &p->a6, Ase1, &p->t3, 1, &p->a2, Agi0,
               &p->s2, 31, &p->a3, Amo1, &p->s4, 27, &p->a4, Abu1, &p->t4, 19,
               lanes, &p->t1);
    chipattern3(Aka1, Ase1, Agi0, Amo1, Abu1, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1, &p->t6);
    thetarhopifinal(Aba0, &p->s0, Ake1, &p->t2, 22, Asi0, &p->s2, 22, Ago0,
                    &p->s1, 11, Amu1, &p->t4, 7, lanes, &p->a2, &p->a3, &p->a4,
                    &p->a5, &p->a6, &p->t1);
    chiiota(Aba0, Ake1, Asi0, Ago0, Amu1, 4, &p->a2, &p->a3, &p->a4, &p->a5,
            &p->a6, lanes, rc, &p->t1);

    thetarhopi(&p->a4, Ama1, &p->s0, 1, &p->a5, Abe1, &p->t2, 22, &p->a6, Aki1,
               &p->a7, 30, &p->a2, Aso0, &p->s1, 14, &p->a3, Agu1, &p->t5, 10,
               lanes, &p->t1);
    chipattern0(Ama1, Abe1, Aki1, Aso0, Agu1, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1);
    thetarhopi(&p->a6, Aga1, &p->s0, 9, &p->a2, Ame0, &p->t3, 1, &p->a3, Abi1,
               &p->a7, 3, &p->a4, Ako1, &p->s1, 13, &p->a5, Asu1, &p->t4, 4,
               lanes, &p->t1);
    chipattern1(Aga1, Ame0, Abi1, Ako1, Asu1, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1, &p->t6);
    thetarhopi(&p->a3, Asa0, &p->t0, 18, &p->a4, Age0, &p->t3, 5, &p->a5, Ami0,
               &p->a7, 7, &p->a6, Abo0, &p->s1, 28, &p->a2, Aku1, &p->t4, 13,
               lanes, &p->t1);
    chipattern2(Asa0, Age0, Ami0, Abo0, Aku1, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1, &p->t6);
    thetarhopi(&p->a5, Aka0, &p->t0, 21, &p->a6, Ase0, &p->t2, 1, &p->a2, Agi1,
               &p->a7, 31, &p->a3, Amo0, &p->s1, 28, &p->a4, Abu0, &p->t5, 20,
               lanes, &p->t1);
    chipattern3(Aka0, Ase0, Agi1, Amo0, Abu0, &p->a2, &p->a3, &p->a4, &p->a5,
                &p->a6, lanes, &p->t1, &p->t6);
    thetarhopifinal(Aba1, &p->t0, Ake0, &p->t3, 22, Asi1, &p->a7, 21, Ago1,
                    &p->s4, 10, Amu0, &p->t5, 7, lanes, &p->a2, &p->a3, &p->a4,
                    &p->a5, &p->a6, &p->t1);
...
round3(uint32_t *lanes, uint32_t *rc, uint32_t *a2, uint32_t *a3, uint32_t *a4,
    ...
    *t5 = *a3 ^ *a2;
    ...
    // used for masks: r2,r8,r9,r10,r11,r12,lr,mDa0,mDo1,mDi0,mDa1,mDo0
    //           = >  a7,t0,t1, t2, t3, t4,t5,  s0,  s1,  s2,  s3,  s4
    thetarhopi(a4, Aga0, t0, 2, a5, Age0, t3, 23, a6, Agi0, s2, 31, a2, Ago0,
               s4, 14, a3, Agu0, t4, 10, lanes, t1);
    chipattern0(Aga0, Age0, Agi0, Ago0, Agu0, a2, a3, a4, a5, a6, lanes, t1);
    thetarhopi(a6, Aka1, t0, 9, a2, Ake1, t2, 0, a3, Aki1, s2, 3, a4, Ako1, s4,
               12, a5, Aku1, t5, 4, lanes, t1);
    chipattern1(Aka1, Ake1, Aki1, Ako1, Aku1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a3, Ama0, s0, 18, a4, Ame0, t2, 5, a5, Ami0, s2, 8, a6, Amo0, s4,
               28, a2, Amu0, t5, 14, lanes, t1);
    chipattern2(Ama0, Ame0, Ami0, Amo0, Amu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a5, Asa1, s0, 20, a6, Ase1, t3, 1, a2, Asi1, s2, 31, a3, Aso1,
               s4, 27, a4, Asu1, t4, 19, lanes, t1);
    chipattern3(Asa1, Ase1, Asi1, Aso1, Asu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopifinal(Aba0, s0, Abe0, t2, 22, Abi0, s2, 22, Abo0, s1, 11, Abu0,
                    t4, 7, lanes, a2, a3, a4, a5, a6, t1);
    chiiota(Aba0, Abe0, Abi0, Abo0, Abu0, 6, a2, a3, a4, a5, a6, lanes, rc, t1);

    thetarhopi(a4, Aga1, s0, 1, a5, Age1, t2, 22, a6, Agi1, a7, 30, a2, Ago1,
               s1, 14, a3, Agu1, t5, 10, lanes, t1);
    chipattern0(Aga1, Age1, Agi1, Ago1, Agu1, a2, a3, a4, a5, a6, lanes, t1);
    thetarhopi(a6, Aka0, s0, 9, a2, Ake0, t3, 1, a3, Aki0, a7, 3, a4, Ako0, s1,
               13, a5, Aku0, t4, 4, lanes, t1);
    chipattern1(Aka0, Ake0, Aki0, Ako0, Aku0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a3, Ama1, t0, 18, a4, Ame1, t3, 5, a5, Ami1, a7, 7, a6, Amo1, s1,
               28, a2, Amu1, t4, 13, lanes, t1);
    chipattern2(Ama1, Ame1, Ami1, Amo1, Amu1, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopi(a5, Asa0, t0, 21, a6, Ase0, t2, 1, a2, Asi0, a7, 31, a3, Aso0,
               s1, 28, a4, Asu0, t5, 20, lanes, t1);
    chipattern3(Asa0, Ase0, Asi0, Aso0, Asu0, a2, a3, a4, a5, a6, lanes, t1,
                t6);
    thetarhopifinal(Aba1, t0, Abe1, t3, 22, Abi1, a7, 21, Abo1, s4, 10, Abu1,
                    t5, 7, lanes, a2, a3, a4, a5, a6, t1);
    chiiota(Aba1, Abe1, Abi1, Abo1, Abu1, 7, a2, a3, a4, a5, a6, lanes, rc, t1);
}
...
void keccakf1600_C(uint32_t *lanes) {
    ...
    int s3 = 6;
    do {
        round0(lanes, rc, &p.a2, &p.a3, &p.a4, &p.a5, &p.a6, &p.a7, &p.s0,
               &p.s1, &p.s2, &p.s4, &p.t0, &p.t1, &p.t2, &p.t3, &p.t4, &p.t5,
               &p.t6);
        round1(lanes, rc, &p.a2, &p.a3, &p.a4, &p.a5, &p.a6, &p.a7, &p.s0,
               &p.s1, &p.s2, &p.s4, &p.t0, &p.t1, &p.t2, &p.t3, &p.t4, &p.t5,
               &p.t6);
        round2(lanes, rc, &p);
        round3(lanes, rc, &p.a2, &p.a3, &p.a4, &p.a5, &p.a6, &p.a7, &p.s0,
               &p.s1, &p.s2, &p.s4, &p.t0, &p.t1, &p.t2, &p.t3, &p.t4, &p.t5,
               &p.t6);
        rc += 8;
        s3--;
