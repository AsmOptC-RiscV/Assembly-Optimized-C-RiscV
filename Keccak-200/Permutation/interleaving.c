...
uint16_t interleave_uint8_with_zeros(const uint8_t input) {
    uint16_t word = input;
...
uint32_t interleave_uint16_with_zeros(const uint16_t input) {
    uint32_t word = input;
...
uint32_t interleave_4_bytes(const uint8_t first, const uint8_t second,
...
uint16_t deinterleave_uint32_part(const uint32_t x) {
...
uint8_t deinterleave_uint16_part(const uint16_t x) {
    uint32_t y = x & 0x55555555;
    y = (y | (y >> 1)) & 0x3333;
    y = (y | (y >> 2)) & 0x0F0F;
    y = (y | (y >> 4)) & 0x00FF;
...
void deinterleave_uint16(uint8_t *part1, uint8_t *part2, const uint16_t z) {
    *part2 = deinterleave_uint32_part(z);
    *part1 = deinterleave_uint32_part(z >> 1);
}

void deinterleave_uint32_to_uint16(uint16_t *part1, uint16_t *part2,
                                   const uint32_t z) {
    *part2 = deinterleave_uint32_part(z);
    *part1 = deinterleave_uint32_part(z >> 1);
}

void deinterleave_uint32_to_bytes(uint8_t *output1, uint8_t *output2,
