...
int crypto_hash_c_opt(unsigned char *out, const unsigned char *in,
    ...
    while (inlen >= 16) {
        ...
        in += 16;
        inlen -= 16;
        gimli_c_opt_lg(&x0, &x1, &x2, &x3, &y0, &y1, &y2, &y3, &z0, &z1, &z2,
                       &z3);
    }
    ...
    x3 = state[3];
    z3 ^= 1 << 24;
    gimli_c_opt_lg(&x0, &x1, &x2, &x3, &y0, &y1, &y2, &y3, &z0, &z1, &z2, &z3);
